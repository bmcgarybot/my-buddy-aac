...
export default defineMessages({
  ...
  importSecondary: {
    ...
    defaultMessage:
      'This option will import JUST the new boards detected. It WILL NOT import the default boards included on My Buddy. Supported formats are {cboardLink} format or {link} format.'
  },
  success: {
