...
export default defineMessages({
  ...
  walkthroughSettingsDesc: {
    ...
    defaultMessage:
      'The settings allows you to configure My Buddy according to your needs. You can change the language, voice, look and feel, elements sizes, enable scanning and many more. '
  },
  walkthroughLanguage: {
  ...
  walkthroughExport: {
    ...
    defaultMessage:
      'Browse options to export your My Buddy boards to use them offline.'
  },
  walkthroughImport: {
