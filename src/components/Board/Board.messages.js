...
export default defineMessages({
  ...
  emptyVoiceAlert: {
    ...
    defaultMessage:
      'WARNING: we did not detect an available Text to Speech voice! My Buddy cannot work properly.'
  },
  offlineVoiceAlert: {
  ...
  walkthroughWelcome: {
    ...
    defaultMessage: 'Welcome to My Buddy!'
  },
  ...
  walkthroughStart: {
    ...
    defaultMessage:
      'Are you ready for a tour across My Buddy app and its awesome features?'
  },
  walkthroughSignInUp: {
